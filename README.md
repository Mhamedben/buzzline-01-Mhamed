...
py -m producers.basic_producer_mhamed
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m producers.basic_producer_mhamed
```
...
```shell
.venv\Scripts\activate
py -m consumers.basic_consumer_mhamed.py
```

Mac/Linux:
```zsh
source .venv/bin/activate
python3 -m consumers.basic_consumer_mhamed.py
```
